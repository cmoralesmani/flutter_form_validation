...
class ProductoBloc {
  // Declaraciones de los escuchas
  final _productosController = new BehaviorSubject<List<ProductoModel>>();
  final _cargandoController = new BehaviorSubject<bool>();

  final _productosProvider = new ProductosProvider();

  // Estos metodos esta disponible en cualquier lugar donde se quiera escuchar cuando
  // algo cambien los controller. Entonces los metodos que cargan, agrega y todo lo demas
  // notifican que cambiaron y los escuchas son notificados.
